...
interface Field_Interface
{
     ...
     */
    public function is_satisfied_by(DateTimeInterface $date, string $value, bool $invert): bool;
    /**
     ...
     */
    public function increment(DateTimeInterface &$date, bool $invert = false, ?string $parts = null): static;
    /**
